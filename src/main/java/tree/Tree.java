...
import tree.nodes.TreeNodeInterface;
...
public class Tree<T> implements Collection<T> {
    ...
    FunctionWithException2Params<T, T, Boolean> comparator;
    ...
    public void setComparator(FunctionWithException2Params<T, T, Boolean> isLower) {
        this.comparator = isLower;
    }
